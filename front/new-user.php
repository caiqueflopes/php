...
<body>
    ...
    <div class="page"><a class="section section-banner d-none d-xl-block" href="https://www.templatemonster.com/intense-multipurpose-html-template.html" style="background-image: url(images/banner/background-04-1920x60.jpg); background-image: -webkit-image-set( url(images/banner/background-04-1920x60.jpg) 1x, url(images/banner/background-04-3840x120.jpg) 2x )"><img src="images/banner/foreground-04-1600x60.png" srcset="images/banner/foreground-04-1600x60.png 1x, images/banner/foreground-04-3200x120.png 2x" alt="" width="1600" height="310"></a>
        ...
        <section class="breadcrumbs-custom-inset">
            <div class="breadcrumbs-custom context-dark bg-overlay-46">
                <div class="container">
                    <h2 class="breadcrumbs-custom-title">Estamos esperando você</h2>
                    <ul class="breadcrumbs-custom-path">
                        <li><a href="index.php">Home</a></li>
                        <li class="active">cadastro</li>
                    </ul>
                </div>
                <div class="box-position" style="background-image: url(images/coelho.png);"></div>
            </div>
        </section>
        <!-- Why choose us-->
        <section class="section section-md section-last bg-default text-md-left">
            <div class="container">
                <div class="col-lg-12">
                    <h4 class="text-spacing-50">Cadastro</h4>
                        ...
                        <div class="row row-14 gutters-14">
                            ...
                            <div class="col-sm-6">
                                <div class="form-wrap">
                                    ...
                                    <label class="form-label" for="contact-last-name">Ultimo Nome</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-wrap">
                            ...
                            <div class="col-5">
                                <div class="form-wrap">
                                    <input class="form-input" id="contact-street" type="text" name="street" data-constraints="@Required">
                                    <label class="form-label" for="contact-street">Rua</label>
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-wrap">
                                    <input class="form-input" id="contact-number" type="text" name="number" data-constraints="@Required">
                                    <label class="form-label" for="contact-number">Numero</label>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-wrap">
                                    <input class="form-input" id="contact-cel" type="text" name="cel" data-constraints="@Required">
                                    <label class="form-label" for="contact-cel">Telefone</label>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-wrap">
                                    <input class="form-input" id="contact-passw" type="text" name="passw" data-constraints="@Required">
                                    <label class="form-label" for="contact-passw">Definir senha</label>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-wrap">
                                    <input class="form-input" id="contact-passw-conf" type="text" name="passw" data-constraints="@Required">
                                    <label class="form-label" for="contact-passw-conf">confirmar senha</label>
                                </div>
                            </div>
                        </div>
                        <button class="button button-primary button-pipaluk" onclick="newElement()">Cadastrar</button>
                    </form>
                </div>
            </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        function newElement() {
            ...
            var name = $("#contact-first-name").val();
            var lname = $("#contact-last-name").val();
            var mail = $("#contact-email").val();
            var street = $("#contact-street").val();
            var number = $("#contact-number").val();
            var phone = $("#contact-cel").val();
            var pass = $("#contact-passw").val();

            $.post("../api/_lib/user/add.php", {
                lname: lname,
                street: street,
                number: number,
                phone: phone,
